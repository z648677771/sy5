...
$ecms_config['db']['dbusername']='www.jpgame123_co';	//数据库用户名
$ecms_config['db']['dbpassword']='ibfWa52Pjs5AJCXy';	//数据库密码
$ecms_config['db']['dbname']='www.jpgame123_co';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='FYofFndqLzOV5mjxZDWfWRWpFPdQsExm71tc';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='qmabz';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='fushp';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='HZa6S1MmdPsTsBV1QguGBokWItlKWw3ldZd';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='AyxEN2cujZbFsjPY37vvaHQX6c0opapenf';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='PMVO8a0Qdo0PvSStB6stXsUyWhekWpNei';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='lSkHQyBJi3jbw7oeBfsuQOtbQO13fEbW';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='zPObpMc5YaQ6Z6A9aex8dZyjGuFd05z';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'手机游戏下载_好玩的手机游戏免费下载-手游5网',
'newsurl'=>'/',
...
'pname'=>'主访问端',
'purl'=>'http://www.xz59.com/',
'ppath'=>'/www/wwwroot/www.xz59.com/',
'postpass'=>'ekKD0IrhgQWTskbLeqpMue1mdTIw1JcWBH2868QMSwt2MaJplmUmKn6vmy76',
'postfile'=>'',
'tempgid'=>'0',
'isclose'=>'0',
'closeadd'=>'0',
...
'listtempf'=>',title,ftitle,newstime,titlepic,smalltext,diggtop,bigpic,',
'tempf'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,bigpic,',
