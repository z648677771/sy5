...
if($orderby=="newstime"){$pai=0;}
else if($orderby=="onclick"){$pai=1;}
else{$pai=2;}
$search2.=$pai.'-';
$page=(int)$_GET['page'];
...
$kaifameigamepage=kaifameigamepage($num,$line,$page_line,$start,$page,$search2);
$kaifameisoftpage=kaifameisoftpage($num,$line,$page_line,$start,$page,$search2);
//页面支持标签
if($public_r['dtcanbq'])
{
...
$listtemp=str_replace('[!--show.kaifameigamepage--]',$kaifameigamepage,$listtemp);
$listtemp=str_replace('[!--show.kaifameisoftpage--]',$kaifameisoftpage,$listtemp);
//取得列表模板
