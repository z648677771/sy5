...
<input name="game_id" type="text" id="game_id" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'game_id',stripSlashes($r[game_id]))?>" size="">
...
<input type="file" name="bigpicfile" size="60">
</td></tr></table>