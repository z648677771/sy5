...
<input name="game_id" type="text" id="game_id" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[game_id]))?>" size="">
...
</div><table width='100%' align=center cellpadding=3 cellspacing=1 bgcolor='#DBEAF5'><tr><td width='16%' height=25 bgcolor='ffffff'>幻灯大图</td><td bgcolor='ffffff'>
<input name="bigpic" type="text" id="bigpic" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[bigpic]))?>" size="60">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=bigpic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a> 
</td></tr></table>