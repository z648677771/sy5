...
<meta http-equiv="mobile-agent" content="format=xhtml; url=<?=$public_r['add_www_kaifamei_com_m']?>/zhuanti/soft/">
<meta http-equiv="mobile-agent" content="format=html5; url=<?=$public_r['add_www_kaifamei_com_m']?>/zhuanti/soft/">
<link rel="shortcut icon" href="/favicon.ico"/>
<link type="text/css" rel="stylesheet" href="/kaifamei/css/index.css" />
<script type="text/javascript">
    (function(){var ua=navigator.userAgent.toLowerCase();var bIsIpad=ua.match(/ipad/i)=="ipad";var bIsIphoneOs=ua.match(/iphone os/i)=="iphone os";var bIsAndroid=ua.match(/android/i)=="android";var bIsWM=ua.match(/windows mobile/i)=="windows mobile";if(bIsIpad||bIsIphoneOs||bIsAndroid||bIsWM){window.location.href="<?=$public_r['add_www_kaifamei_com_m']?>/zhuanti/soft/"}})();
</script>
</head>
<body>
 <!-- seo优化 -->
...
<div class="topic_list_wrap w1168 bg ">
  <div class="menu_tab_wrap ">
    ...
    <div class="tab_box">
      <ul class="tab_menu">
        <li><a href="/zhuanti/game/">游戏专题</a></li>
        <li class="current"><a href="/zhuanti/soft/">应用专题</a></li>
      </ul>
