...
$ecms_config['db']['dbusername']='eoe_xz59';	//数据库用户名
$ecms_config['db']['dbpassword']='3kHSELKr34T5nKam';	//数据库密码
$ecms_config['db']['dbname']='eoe_xz59';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='www_kaifamei_com_';	//数据表前缀
$dbtbpre=$ecms_config['db']['dbtbpre'];	//数据表前缀
$ecms_config['db']['showerror']=0;	//显示SQL错误提示(0为不显示,1为显示)
...
$ecms_config['esafe']['ecookiernd']='QMdKCa41203XK9KMFkLobFWLau3wFdvINrjI';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='aubxe';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='npayn';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='7VYFJ5uUFJzEp0jffz37XOQUE82YYIORwrP';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='Tr9G27ONJtWrwrQ4pENxVIdcN0eyFOupZb';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='amamDJMMkdji2aECeyLmH2oqTawIIsXdz';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='FMjp3p3HnO9NUZdljUymO0QTzyduT9WC';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='8aDjpL2GXYgkXn1wBLSlENrxn46w7zy';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'手机游戏下载_好玩的手机游戏免费下载-手游5下载网',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'xczqH53eH9skij3WZTq5Py7SetycUkni',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/game/\">手机游戏</a>&nbsp;|&nbsp;<a href=\"/zhuanti/\">专题合集</a>&nbsp;|&nbsp;<a href=\"/news/\">新闻资讯</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'rewriteclass'=>'',
'rewriteinfotype'=>'',
'rewritetags'=>'tags/[!--tagname--]_[!--page--].html',
'rewritepl'=>'',
'memberconnectnum'=>0,
'closehmenu'=>'',
'indexaddpage'=>0,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'F7DP2zAfFnj6AthL25l70OJFnFZovRy1wm4s',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'D9ioBfsTwhud1jnLX5Srcxt9dS7GHppodBNQc3Cqta',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>1,
...
'ctimeaddre'=>0,
'ctimeqaddre'=>0,
'deftempid'=>0,'add_www_kaifamei_com_m'=>'http://eoem.xz59.com','add_www_kaifamei_com_name'=>'手游5网','add_www_kaifamei_com_www'=>'http://eoe.xz59.com','add_www_kaifamei_com_tongji'=>'','add_www_kaifamei_com_qq'=>'208115365','add_www_kaifamei_com_beian'=>'琼ICP备17004651号-3');
//------------e_public
...
'pname'=>'主访问端',
'purl'=>'http://eoe.xz59.com/',
'ppath'=>'/www/wwwroot/www.copyeoe.com/',
'postpass'=>'ufnGrwziHRgeGVvGlur8JSOOqzHXpvd6fBno3Q0v9s4ok9K9S4chOOhNS7oB',
'postfile'=>'',
'tempgid'=>'0',
'isclose'=>'0',
'closeadd'=>'0',
...
'pname'=>'手机访问端',
'purl'=>'http://eoem.xz59.com/',
'ppath'=>'/www/wwwroot/www.copyeoe.com/m/',
'postpass'=>'EyBVtaWXWWpOwC4J1zpMv29BLYLgNdA1mIlkqZanCZ20J0EkA6vRXeRts3vM',
'postfile'=>'',
'tempgid'=>'2',
'isclose'=>'0',
'closeadd'=>'0',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,game_id,special.field,newstime,titlepic,smalltext,writer,befrom,newstext,bigpic,',
'qenter'=>',title,ftitle,game_id,special.field,titlepic,smalltext,writer,befrom,newstext,bigpic,',
'listtempf'=>',title,ftitle,game_id,newstime,titlepic,smalltext,diggtop,bigpic,',
'tempf'=>',title,ftitle,game_id,newstime,titlepic,smalltext,writer,befrom,newstext,diggtop,bigpic,',
'mustqenterf'=>',title,game_id,newstext,',
'listandf'=>'',
'setandf'=>0,
'searchvar'=>',title,smalltext,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,newstext,bigpic,',
'canaddf'=>',title,ftitle,game_id,newstime,titlepic,smalltext,writer,befrom,newstext,bigpic,',
'caneditf'=>',title,ftitle,game_id,newstime,titlepic,smalltext,writer,befrom,newstext,bigpic,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,bigpic,game_id,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,bigpic,game_id,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,special.field,newstime,titlepic,smalltext,befrom,type,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,newstext,diggtop,morepic,qx,writer,kf_type,phone,email,real_name,check_verity_img,company_name,company_code,company_site,company_desc,company_address,',
'qenter'=>',title,ftitle,special.field,newstime,titlepic,smalltext,befrom,type,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,newstext,diggtop,morepic,qx,writer,kf_type,phone,email,real_name,check_verity_img,company_name,company_code,company_site,company_desc,company_address,',
'listtempf'=>',title,ftitle,newstime,titlepic,smalltext,type,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,diggtop,morepic,qx,',
'tempf'=>',title,ftitle,newstime,titlepic,smalltext,befrom,type,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,newstext,diggtop,morepic,qx,writer,kf_type,phone,email,real_name,check_verity_img,company_name,company_code,company_site,company_desc,company_address,',
'mustqenterf'=>',title,',
'listandf'=>',type,',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,ftitle,newstime,titlepic,smalltext,befrom,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,newstext,diggtop,morepic,qx,writer,',
'canaddf'=>',title,ftitle,newstime,titlepic,smalltext,befrom,type,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,newstext,diggtop,morepic,qx,writer,kf_type,phone,email,real_name,check_verity_img,company_name,company_code,company_site,company_desc,company_address,',
'caneditf'=>',title,ftitle,newstime,titlepic,smalltext,befrom,type,typei,size,bb,xtyq,yy,kfs,yjh,downurl,downurli,downurli2,downurl2,newstext,diggtop,morepic,qx,writer,kf_type,phone,email,real_name,check_verity_img,company_name,company_code,company_site,company_desc,company_address,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,type,typei,size,morepic,bb,xtyq,yy,kfs,yjh,qx,downurl,downurli,downurli2,downurl2,',
'tbdataf'=>',writer,befrom,newstext,kf_type,phone,email,real_name,check_verity_img,company_name,company_desc,company_code,company_site,company_address,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,type,typei,size,morepic,bb,xtyq,yy,kfs,yjh,qx,downurl,downurli,kf_type,phone,email,real_name,check_verity_img,company_name,company_desc,company_code,company_site,company_address,downurli2,downurl2,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,titlepic,smalltext,writer,befrom,type,typei,size,bb,xtyq,yy,kfs,downurl,yjh,downurli,newstext,diggtop,morepic,qx,',
'qenter'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,type,typei,size,bb,xtyq,yy,kfs,downurl,yjh,downurli,newstext,diggtop,morepic,qx,',
'listtempf'=>',title,ftitle,newstime,titlepic,smalltext,type,typei,size,bb,xtyq,yy,kfs,downurl,yjh,downurli,morepic,qx,',
'tempf'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,type,typei,size,bb,xtyq,yy,kfs,downurl,yjh,downurli,newstext,diggtop,morepic,qx,',
'mustqenterf'=>',title,',
'listandf'=>',type,',
'setandf'=>0,
'searchvar'=>',title,',
'cj'=>',title,',
'canaddf'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,type,typei,size,bb,xtyq,yy,kfs,downurl,yjh,downurli,newstext,diggtop,morepic,qx,',
'caneditf'=>',title,ftitle,newstime,titlepic,smalltext,writer,befrom,type,typei,size,bb,xtyq,yy,kfs,downurl,yjh,downurli,newstext,diggtop,morepic,qx,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,type,typei,size,morepic,bb,xtyq,yy,kfs,downurl,yjh,qx,downurli,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,type,typei,size,morepic,bb,xtyq,yy,kfs,downurl,yjh,qx,downurli,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
